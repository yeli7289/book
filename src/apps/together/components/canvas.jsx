class Canvas extends React.Component {
    ...
    refresh(){
    var pixelDataRef = new Firebase('https://traveltommy.firebaseio.com/Groups/'+this.props.groupName+'/drawing');
    var mapRef = new Firebase('https://traveltommy.firebaseio.com/Groups/'+this.props.groupName+'/Map');
    ...
    resetMap(){
        ...
        var mapRef = new Firebase('https://traveltommy.firebaseio.com/'+this.props.groupName+'/Map');
